...
public class EnemySpawn : MonoBehaviour
{
    ...
    public void SpawnEnemy(Vector2Int position, float tileScaling)
    {
        ...
        enemy.ac = GetComponent<EnemiesData>().enemies[dataID].ac;
        enemy.hp = GetComponent<EnemiesData>().enemies[dataID].hp;
        enemy.baseAttack = GetComponent<EnemiesData>().enemies[dataID].baseAttack;
        enemy.diceDamage = GetComponent<EnemiesData>().enemies[dataID].diceDamage;
        enemy.sidesDamage = GetComponent<EnemiesData>().enemies[dataID].sidesDamage;
        enemy.bonusDamage = GetComponent<EnemiesData>().enemies[dataID].bonusDamage;
